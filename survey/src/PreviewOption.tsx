...
const PreviewOption: React.FC<PreviewOptionProps> = ({ option, index, questionType, moveOption, onUpdateOption, options }) => {
    ...
    if (questionType === '객관식 질문') {
        inputElement = <input type="radio" name="option" value={option} readOnly />;
    } else if (questionType === '체크박스ㅤ') {
        inputElement = <input type="checkbox" name="option" value={option} readOnly />;
